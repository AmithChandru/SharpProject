window.addEventListener("DOMContentLoaded",()=>{
  axios.get('https://crudcrud.com/api/028a09ff4b8f42a3ae815fdb271613c8/Orders')
      .then((res)=>{
...
function submitOrder(e){
  ...
  axios.post('https://crudcrud.com/api/028a09ff4b8f42a3ae815fdb271613c8/Orders', obj)
      .then((res)=>{
...
function deleteOrder(_id){
  axios.delete(`https://crudcrud.com/api/028a09ff4b8f42a3ae815fdb271613c8/Orders/${_id}`)
      .then(()=>{
